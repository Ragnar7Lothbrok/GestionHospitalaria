        ...
        static void AtenderPacientes()
        {
            foreach (var paciente in colaPacientes.GetConsumingEnumerable())
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Paciente {paciente.Id}. Llegado el {paciente.LlegadaHospital}. Estado: {paciente.Estado}. Duración Espera: {duracionEspera} segundos.");
                    ...
                    Console.WriteLine($"Paciente {paciente.Id}. Llegado el {paciente.LlegadaHospital}. Estado: {paciente.Estado}. Duración Consulta: {duracionConsulta} segundos. Atendido por el Médico {numeroMedico + 1}.");
                }
                finally
                {
